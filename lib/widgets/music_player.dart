...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  init() async {
    ...
    //Set Audio Session
    await _audioHandler.setAudioSession(
                  ...
                  PopupMenuItem(
                    onTap: () async {
                      Future.delayed(const Duration(milliseconds: 50), () async {
                        ...
                        if (playlist != null) {
                          int? isSuccess = await _playlistController
                              .updateSongs(
            ...
            child: Column(
              ...
              children: [
                Hero(
                  tag: '_placeholder',
                  createRectTween:
                      (begin, end) => CustomRectTween(begin: begin!, end: end!),
                ...
                Row(
                  ...
                  children: [
                    Tooltip(
                      message: 'Show Lyrics',
                      child: buildLyricsButton(size),
                    ),
                    Tooltip(
                      message: 'Switch Loop Mode',
                      child: ControlButton.buildLoopButton(
                        _audioPlayer,
                    ...
                    Tooltip(
                      ...
                      child: ControlButton.buildShuffleButton(
                        _audioPlayer,
                        ...
                        lyrics == null
                            ? FutureBuilder(
                              future: Future<String>(() async {
                                ...
                                try {
                                  var payload = LyricApi.getArtistAndTrack(
                                    title,
                                  );
