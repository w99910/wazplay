...
class TermsAndConditions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('Terms and Conditions', style: textTheme.displaySmall),
        ...
        const SizedBox(height: 12),
        Text('- Restrictions', style: textTheme.titleMedium),
        const SizedBox(height: 6),
        const Text(
          'You are not allowed to selling or sub-licensing this app for your own profit or others. ',
        ),
        const SizedBox(height: 12),
        Text('- Intellectual Property Rights', style: textTheme.titleMedium),
        const SizedBox(height: 6),
        const Text(
